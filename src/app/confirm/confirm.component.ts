...
export class ConfirmComponent implements OnInit {
  ...
  ngOnInit(): void {   
    ...
    generate(){
      const url: string = "https://122.248.120.187:4443/payment-api/v1/qr/generate-transaction.service"; 
    ...
    save(obj){
      ...
      const url: string = window["_apiurl"] +"/operation/saveCBPaytransaction";
